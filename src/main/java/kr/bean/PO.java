...
public class PO implements Comparable<PO> {
	...
	public String getCategoryMatchId() {return categoryMatchId;}

	public static Comparator<PO> comparator = (o1, o2) -> {
        String o1str = o1.getId3().toString() + o1.getId2().toString() ;//+ o1.getId1().toString();
		String o2str = o2.getId3().toString() + o2.getId2().toString() ;//+ o2.getId1().toString();
	...
	public PO(String id, String source, String target, boolean isFillEmptyTrg) {
		...
		id2 = Integer.parseInt(ids[1]);
		id3 = Integer.parseInt(ids[2]);
		this.categoryMatchId = ids[2]+ids[1]+ids[0];
		if(isFillEmptyTrg) {
			if (target.equals("")) this.target = source;
			else if (source.equals("")) this.source = target;
		}
	...
	private String id, source, target, stringFileName, categoryMatchId;
